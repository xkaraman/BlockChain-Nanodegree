...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        // Does eqaulity precedes "OR"? or need to parenthesi equations?
        require( msg.sender == ownerOf(_tokenId1) || msg.sender == ownerOf(_tokenId2), "Sender not owning one of the tokens");
        ...
        // _transferFrom is not implemented in ERC openzeppelin latest verion
        // should a safeTrasnferFrom should be used ?
